...
function createEditButton(eventId) {
  let button = $('<button>', {
    ...
    click: function() {
      // Ajax GET request untuk mendapatkan detail event
      window.location.href = `${baseUrl}/edit-event/${eventId}`;
    }
  });
  return button;
}
    ...
    click: function() {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          $.ajax({
            type: 'DELETE',
            url: `${baseUrl}/delete-event/` + eventId, // Sesuaikan dengan URL dan parameter yang sesuai
            data: {
            ...
            error: function(xhr, status, error) {
              ...
              Swal.fire({
                ...
                text: 'Terjadi kesalahan saat menghapus acara.' + error,
              });
            }
          });
        }
