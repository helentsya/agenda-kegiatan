            ...
            <div class="relative mb-4 w-full">
                ...
                <select id="countries" name="id_bidang"
                    ...
                    @foreach ($bidang as $item1)
                        <option {{ $id_bidang == $item1->id ? 'selected' : '' }} value="{{ $item1->id }}">{{ $item1->nama_bidang }}</option>
                    @endforeach
                </select>
            </div>
            <div class="relative mb-4 w-full">
            ...
            <div class="relative mb-4 w-full">
                ...
                <select id="countries" name="id_ruangan"
                    ...
                    @foreach ($ruangan as $item2)
                        <option value="{{ $item2->id }}" {{ $tempat == $item2->nama_ruangan ? 'selected' : '' }}>{{ $item2->nama_ruangan }}</option>
                    @endforeach
                </select>
            </div>
            {{-- <div class="relative mb-4 w-full">
